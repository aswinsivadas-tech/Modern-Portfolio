...
const quickdraw = '/assets/badges/quickdraw.png';
// const pairExtraordinaire = '/assets/badges/pair-extraordinaire.png';
const yolo = '/assets/badges/yolo.png';
...
const leetcode75 = '/assets/badges/leetcode-75-new.gif';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <ScrollHeading className="text-center mb-14 sm:mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tighter text-text-primary mb-6">
            Badges <DiaTextReveal text="& Trophies" textColor="#0ea5e9" className="font-serif italic" duration={1.5} delay={0.3} />
          </h2>
        ...
        <ScrollReveal animationNum={0} direction="up">
          <div className="relative w-full max-w-4xl mx-auto flex items-center justify-center -mt-6 sm:-mt-10">
            <OrbitImages
              images={images}
              shape="ellipse"
              radiusX={370}
