    ...
    <AnimatePresence mode="wait">
      {visible && (
        ...
        >
          {/* Glass background */}
          <span
            className="absolute inset-0 rounded-full border border-white/10 shadow-[0_8px_32px_rgba(14,165,233,0.3)] group-hover:border-[#0ea5e9]/50 transition-all duration-300"
            style={{
          ...
          <span className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-[radial-gradient(circle_at_center,rgba(14,165,233,0.15),transparent_70%)]" />
          ...
          <svg
            ...
            className="relative z-10 w-[18px] h-[18px] text-sky-300 group-hover:text-amber-300 transition-colors duration-200"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2.5}
