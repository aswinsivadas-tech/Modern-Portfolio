    ...
    >
      ...
      <div className="absolute inset-0 z-5 flex items-center justify-center pointer-events-none select-none">
        ...
        >
          ...
          >
            <h1
              className={`flex justify-between w-full text-[8vw] sm:text-[10vw] md:text-[12vw] font-big-shoulders font-black leading-none uppercase whitespace-nowrap select-none scale-y-[1.0] scale-x-[0.9] tracking-[-0.05em] origin-center ${theme === 'dark' ? 'text-white/40' : 'text-black/[0.3]'
                }`}
            >
              <span>ASWIN</span>
              <span>SIVADAS</span>
            ...
            <motion.h1
              className={`absolute inset-0 flex justify-between w-full px-[2vw] sm:px-[5vw] md:px-[10vw] text-[8vw] sm:text-[10vw] md:text-[12vw] font-big-shoulders font-black leading-none uppercase whitespace-nowrap select-none scale-y-[1.0] scale-x-[0.9] tracking-[-0.05em] origin-center ${theme === 'dark' ? 'text-white' : 'text-black'
                }`}
              style={{
        ...
        >
          <div className="relative w-full aspect-square md:aspect-[4/5] flex items-center justify-center">
            <motion.img
              src={heroImg}
              alt="Aswin Sivadas"
              className="w-[150%] h-[150%] md:w-[170%] md:h-[170%] lg:w-[190%] lg:h-[190%] object-contain contrast-[1.1] brightness-[1.1] select-none pointer-events-none drop-shadow-[0_20px_50px_rgba(14,165,233,0.4)] relative z-20"
