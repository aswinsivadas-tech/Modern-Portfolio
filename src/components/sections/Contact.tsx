      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <ScrollHeading className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-text-primary leading-none transform-gpu translate-z-0">
            Let's <DiaTextReveal text="Connect" textColor="#0ea5e9" className="font-serif italic" duration={1.5} delay={0.3} />
          </h2>
        </ScrollHeading>
            ...
            <div className="space-y-6 transform-gpu translate-z-0" style={{ transform: 'translateZ(40px)' }}>
              <div className="flex items-center justify-between border-b border-border-main pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-sm font-black uppercase tracking-[0.4em] text-text-primary transform-gpu translate-z-0">Direct Line</h3>
                </div>
            ...
            <div className="space-y-6 transform-gpu translate-z-0" style={{ transform: 'translateZ(40px)' }}>
              <div className="flex items-center justify-between border-b border-border-main pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-sm font-black uppercase tracking-[0.4em] text-text-primary transform-gpu translate-z-0">Ecosystem</h3>
                </div>
                ...
                {SOCIAL_LINKS.map((social) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 transform-gpu translate-z-0">
                      <p className="text-sm font-bold text-text-primary group-hover/soc:text-text-primary transition-colors leading-none mb-1 subpixel-antialiased">
                        {social.name}
                      </p>
