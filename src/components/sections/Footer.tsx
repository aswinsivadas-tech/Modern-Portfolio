...
const SOCIAL_LINKS = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/aswinsivadas-tech/",
  ...
  {
    label: "Email",
    href: "mailto:aswinsivadas.tech@gmail.com",
    icon: <Mail size={20} />,
  },
];
    ...
    <>
      ...
      <footer ref={footerRef} style={{ position: "relative", overflow: "hidden", background: "transparent", fontFamily: "'DM Sans',sans-serif", color: "var(--color-text-primary)" }}>
        ...
        <motion.div
          ...
          <h2 style={{ fontFamily: "'Syne',sans-serif", fontSize: "clamp(40px,7vw,72px)", fontWeight: 800, lineHeight: 1, margin: "0 0 20px", animation: "float-kf 5s ease-in-out infinite", cursor: "default", userSelect: "none", display: "inline-block" }}>
            <GradientText
              colors={["#ea580c", "#fb923c", "#fdba74", "#ea580c"]}
              animationSpeed={4}
              showBorder={false}
              className="px-4"
            >
        ...
        <motion.div
          ...
          <motion.div variants={{ initial: { y: 30, opacity: 0 }, whileInView: { y: 0, opacity: 1, transition: { duration: 0.8, ease: [0.16, 1, 0.3, 1] } } }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
              <div style={{ width: 34, height: 34, borderRadius: 10, background: "linear-gradient(135deg,#ea580c,#f97316)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 15, color: "#fff", boxShadow: "0 0 18px rgba(234,88,12,.55)", flexShrink: 0 }}>A</div>
              <span style={{ fontFamily: "'Syne',sans-serif", fontSize: 15, fontWeight: 700, color: "#fff5f0", letterSpacing: "0.02em" }}>Aswin Sivadas</span>
            </div>
        ...
        <motion.div
          ...
          <p style={{ fontSize: 11, color: "var(--color-text-secondary)", letterSpacing: "0.025em", margin: 0 }}>
            © {year} Aswin Sivadas. Crafted with <span style={{ color: "#f97316" }}>♥</span> &amp; caffeine.
          </p>
